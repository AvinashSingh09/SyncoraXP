        ...
        <div className="w-full h-full relative overflow-hidden bg-black flex flex-col">
            ...
            <div className="absolute top-5 left-0 w-full px-6 sm:px-8 z-20 flex justify-between items-center pointer-events-none">
                ...
                >
                    ...
                    <span style={{ fontSize: '11px', fontWeight: 700 }}>Back to Expo Halls</span>
                </button>
                ...
                <div 
                    ...
                    style={{ fontSize: '11px' }}
                >
                    <span style={{ color: '#60a5fa', fontWeight: 800, fontSize: '10px', textTransform: 'uppercase', letterSpacing: '0.05em' }}>Currently Viewing</span>
                    <span style={{ color: 'rgba(255, 255, 255, 0.3)', fontSize: '10px' }}>|</span>
                    <span style={{ color: '#ffffff', fontWeight: 900, fontSize: '11px', textTransform: 'uppercase', letterSpacing: '0.05em' }}>HALL {currentId}</span>
                </div>
            </div>
