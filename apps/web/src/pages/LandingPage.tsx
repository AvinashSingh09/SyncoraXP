  ...
  return (
    <main className="landing-page">
      ...
      <div className="landing-theme-pink-dots">
                ...
                {[0, 1, 2].map((offset) => {
                  ...
                  return (
                    <div key={`${item.name}-${offset}`} style={{ background: "rgba(255, 255, 255, 0.68)", border: "1px solid rgba(126, 34, 206, 0.15)", borderRadius: "24px", padding: "32px 28px", display: "flex", flexDirection: "column", justifyContent: "space-between", gap: "24px", boxShadow: "0 15px 35px rgba(91, 33, 182, 0.05)", backdropFilter: "blur(12px)", transition: "all 0.3s ease", height: "100%", minHeight: "290px" }}>
                      ...
                      <p style={{ color: "#3b2166", fontSize: "15px", lineHeight: "1.65", fontStyle: "italic", margin: 0 }}>
                        "{item.quote}"
                      </p>
                      <div style={{ height: "1px", background: "rgba(126, 34, 206, 0.1)", width: "100%" }} />
                      <div style={{ display: "flex", alignItems: "center", justifyContent: "space-between" }}>
                        <div>
                          <h4 style={{ font: "800 17px 'Manrope', sans-serif", color: "#1e1b4b", margin: 0 }}>{item.name}</h4>
                          <p style={{ color: "#6b7280", fontSize: "12.5px", margin: "4px 0 8px" }}>{item.role}</p>
                          <span style={{ display: "inline-flex", alignItems: "center", gap: "6px", color: "#7e22ce", fontSize: "11px", fontWeight: 800, letterSpacing: "0.08em" }}>
                            <span style={{ width: "12px", height: "2px", background: "#7e22ce" }} />
                            {item.country}
                          </span>
                        </div>
                        <img src={item.avatar} alt={item.name} style={{ width: "54px", height: "54px", borderRadius: "50%", objectFit: "cover", border: "2px solid #7e22ce", boxShadow: "0 6px 16px rgba(126,34,206,0.2)" }} />
                      </div>
                    </div>
                  );
                })}
            ...
            <div style={{ display: "flex", alignItems: "center", gap: "8px", marginTop: "12px" }}>
              {testimonials.map((_, idx) => (
                <button
                  ...
                  style={{ width: idx === testimonialIndex ? "28px" : "8px", height: "8px", borderRadius: "999px", background: idx === testimonialIndex ? "#7e22ce" : "rgba(126, 34, 206, 0.2)", border: "none", cursor: "pointer", transition: "all 0.3s ease", boxShadow: idx === testimonialIndex ? "0 0 12px rgba(126, 34, 206, 0.4)" : "none" }}
                />
              ))}
            </div>
          </div>
        ...
        <section style={{ width: "100%", padding: "90px 0 110px", background: "transparent", color: "#2a1758", textAlign: "center" }}>
